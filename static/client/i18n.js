			...
			resources: {
				...
				bg: {
					translation: {
						...
						about: {
							title: 'Относно нашите кемпери',
							body: "Нашият кемпери са напълно оборудвани за вашето приключение. Те са лесни за шофиране, бързи и способни на чисто нови 4x4 машини. Можете удобно да карате и спите 4 човека в кемперите. Линията VW California е символична почти 60 години и затова мислим, че това е най-добрият избор за наслаждаване на нашите прекрасни български езера, планини и плажове.",
							miles: {
								title: 'Неограничени километри',
								body: "Километри и усмивки звучат добре. Затова нашите кемпери не са ограничени по обхват или държави, които можете да посетите. Мислете за предстоящото приключение и ние ще се погрижим да сте добре подготвени да го изживеете максимално. Ако се поиска, можем да ви предложим добри къмпинги по маршрута ви или живописни места, които трябва да посетите и да разположите лагер."
							},
							cutlery: {
								title: 'Предоставени прибори',
								body: {
									'1': 'Избрахме най-добрите прибори от Victorinox и Stanley.',
									'2': "Пълна кухненска основа на Stanley: неръждаема стомана 18/8 (3,5 L), с отвори за проветряване, тиган с 3 слоя, дъска за рязане, шпатула с разтегателна дръжка, сервираща лъжица с разтегателна дръжка, 4 чинии (диаметър 15,2 см), 4 купи (.65 L), 4 спорки, стойка за съхранение на съдове, подложка, заключващ багажник",
							...
							bedding: {
								...
								body: "Оборудвахме нашите кемпери с висококачествено спално бельо за 4 човека, което включва: 2 двойни спални чаршафи, 2 двойни покривки, 4 възглавници. Кемперите са също оборудвани с вътрешна маса за хранене на закрито, вода, газова печка и голям хладилник. В превозните средства има 2 сгъваеми стола и допълнителна сгъваема маса за открито, която е аккуратно скрита в вратите на автомобила."
							}
						},
						pricing: {
							title: 'Прости цени',
							body1: 'Няма променливи цени. Не повече рекламиране на една цена, която след това се удвоява с допълнителни такси.',
							body2: {
								'1': 'Взимаме начална ',
